...
## Summary
- 1462 nodes · 2833 edges · 143 communities (129 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `619d11ce`
...
- main
- run_v8_historical_gate_compat.py
- validate_sector
...
- validate_v8_release_topology.py
...
- validate_v8_pipeline_compat.py
...
- run_v8_legacy_tail_compat.py
- main
- validate_ci_v56.py
- validate_decision_compression_v531.py
- validate_engagement_clarity_v63.py
- validate_legal_intelligence_demo_v73.py
- validate_route_contract_v80.py
- validate_v8_pipeline_shadow.py
- apply_commercial_evidence_v74.py
- patch
- apply_operations_v49.py
- apply_ux_v45.py
- materialize_v8_pipeline_integration_candidate.py
- validate_v8_contrast_tokens.py
- main
- validate_v8_workflow_integration.py
- v8-pilot-materialization.spec.mjs
- experiencia.js
...
- `main()` --calls--> `main()`  [EXTRACTED]
  scripts/apply_handoff_observability_v518.py → scripts/apply_experience_sectors_v60.py
- `main()` --calls--> `main()`  [EXTRACTED]
  scripts/apply_handoff_observability_v518.py → scripts/apply_experience_solutions_v60.py
...
### Community 0 - "apply_handoff_observability_v518.py"
Cohesion: 0.05
Nodes (61): depth_markup(), extract_contact_section(), main(), normalize_contact_block(), normalize_css_link(), normalize_focusable_decks(), normalize_layout_whitespace(), patch_home() (+53 more)

### Community 1 - "load_site_config"
Cohesion: 0.07
Nodes (44): contact_href(), main(), managed_remove(), patch_index(), patch_sitemap(), render_hub(), render_solution(), route_cards() (+36 more)

### Community 2 - "helpers.mjs"
Cohesion: 0.07
...
### Community 5 - "render_v8_pilot.py"
Cohesion: 0.14
Nodes (36): current_route(), fail(), main(), output_path(), preserve_available_related_links(), Path, Evita que un candidate parcial enlace targets v8 que aún no existen., relative_from_target() (+28 more)

### Community 6 - "run_quality_v55.mjs"
Cohesion: 0.07
...
### Community 7 - "apply_capability_truth_v521.py"
Cohesion: 0.13
...
### Community 8 - "apply_experience_perspectives_v60.py"
Cohesion: 0.18
Nodes (24): article_hero_parts(), authority_block(), central_decision(), clean(), e(), ensure_styles(), extract_hub_legacy(), extract_main() (+16 more)

### Community 9 - "render_catalog_static.mjs"
Cohesion: 0.16
Nodes (22): bodyInner(), bodyInnerProduct(), bodyInnerService(), cards(), catalogFiles, contactBlock(), end, enhanceHeadAndScripts() (+14 more)

### Community 10 - "validate_decision_v58.py"
Cohesion: 0.17
...
### Community 11 - "apply_production_v50.py"
Cohesion: 0.18
...
### Community 33 - "enrich_editorial_pages.py"
Cohesion: 0.31
Nodes (13): absolute_url(), breadcrumb_schema(), contact_url(), enrich(), head_block(), main(), managed_pattern(), prefix_for() (+5 more)

### Community 34 - "validate_experience_perspectives_v60.py"
Cohesion: 0.38
Nodes (13): assert_contains(), assert_once(), balanced_tag_block(), clean(), fail(), hub_cards(), hub_legacy(), main() (+5 more)

### Community 35 - "validate_v8_release_topology.py"
Cohesion: 0.35
Nodes (13): builder_path_patterns(), fail(), git(), job_section(), load_json(), main(), Path, require_mapping() (+5 more)

### Community 36 - "apply_decision_compression_v531.py"
Cohesion: 0.33
Nodes (12): ensure_style(), main(), patch_detail(), patch_solution(), Path, semver(), solution_close(), solution_open() (+4 more)

### Community 37 - "apply_legal_intelligence_discovery_v70.py"
Cohesion: 0.33
...
### Community 41 - "validate_proof_v512.py"
Cohesion: 0.35
...
### Community 42 - "apply_commercial_brief_v513.py"
Cohesion: 0.33
...
### Community 65 - "run_v8_legacy_tail_compat.py"
Cohesion: 0.57
Nodes (7): fail(), final_projection(), historical_direct(), is_final_v8(), main(), Path, run()

### Community 66 - "main"
Cohesion: 0.64
Nodes (7): comparable_files(), digest(), fail(), load(), main(), Path, run()

### Community 67 - "validate_ci_v56.py"
Cohesion: 0.46
...
### Community 68 - "validate_decision_compression_v531.py"
Cohesion: 0.61
Nodes (7): details_opening(), fail(), main(), semver(), validate_contract(), validate_deep(), validate_solutions()

### Community 69 - "validate_engagement_clarity_v63.py"
Cohesion: 0.46
Nodes (7): body_attr(), e(), extract_group(), load_json(), load_sources(), main(), Path

### Community 70 - "validate_legal_intelligence_demo_v73.py"
Cohesion: 0.57
Nodes (7): fail(), link_exists(), load_json(), main(), Path, source_for(), validate_lifecycle()

### Community 71 - "validate_route_contract_v80.py"
Cohesion: 0.50
Nodes (7): canonical_from_html(), fail(), main(), Path, robots_from_html(), route_to_path(), route_to_url()

### Community 72 - "validate_v8_pipeline_shadow.py"
Cohesion: 0.54
Nodes (7): fail(), load(), main(), Path, run(), validate_contract(), validate_workflow()

### Community 73 - "apply_commercial_evidence_v74.py"
Cohesion: 0.52
...
### Community 75 - "apply_operations_v49.py"
Cohesion: 0.52
...
### Community 77 - "materialize_v8_pipeline_integration_candidate.py"
Cohesion: 0.71
Nodes (6): digest_text(), fail(), main(), patch_builder(), patch_pages(), replace_once()

### Community 78 - "validate_v8_contrast_tokens.py"
Cohesion: 0.52
Nodes (6): channel(), luminance(), main(), parse_tokens(), ratio(), require()

### Community 79 - "main"
Cohesion: 0.71
Nodes (6): fail(), load(), main(), Path, run(), validate_contract()

### Community 80 - "validate_v8_workflow_integration.py"
Cohesion: 0.57
Nodes (6): digest(), fail(), load(), main(), Path, run()

### Community 81 - "v8-pilot-materialization.spec.mjs"
Cohesion: 0.33
Nodes (5): audit(), blockingImpacts, compact(), pilots, wcagTags

### Community 82 - "experiencia.js"
Cohesion: 0.47
Nodes (3): createResult(), evidenceNote(), urgencyNote()

### Community 83 - "apply_quality_v48.py"
Cohesion: 0.60
...
### Community 85 - "validate_handoff_v517.py"
Cohesion: 0.60
Nodes (5): contact_pages(), main(), public_html(), Path, require()

### Community 86 - "validate_legal_intelligence_deep_offers_v70.py"
Cohesion: 0.67
Nodes (5): fail(), main(), markers(), validate_source_support(), visible()

### Community 87 - "validate_offer_commercial_v530.py"
Cohesion: 0.60
Nodes (5): main(), semver(), source_ids(), validate_contract(), validate_pages()

### Community 88 - "validate_quality_v55.py"
Cohesion: 0.53
...
### Community 89 - "validate_v8_pilot_materialized.py"
Cohesion: 0.67
Nodes (5): fail(), main(), Path, target_path(), validate_local_links()

### Community 90 - "validate_v8_pilot_infra.py"
Cohesion: 0.60
Nodes (4): fail(), main(), Path, route_path()

### Community 93 - "apply_engagement_v511.py"
Cohesion: 0.83
Nodes (3): block(), main(), remove_block()

### Community 94 - "build_catalog_shells.py"
Cohesion: 0.83
Nodes (3): json_ld(), main(), render()

### Community 95 - "run_v8_pages_quality_compat.py"
Cohesion: 1.00
Nodes (3): fail(), main(), run()

### Community 96 - "validate_browser_v54.py"
Cohesion: 0.83
Nodes (3): main(), require(), semver()

### Community 97 - "validate_commercial_evidence_v74.py"
Cohesion: 1.00
Nodes (3): fail(), main(), resolve_lifecycle()

### Community 98 - "validate_conversion_path_v528.py"
Cohesion: 0.83
Nodes (3): main(), require(), semver()

### Community 99 - "validate_editorial_ux_v47.py"
Cohesion: 0.83
Nodes (3): between(), fail(), semver_tuple()

### Community 100 - "validate_funnel_trust_v529.py"
Cohesion: 0.83
Nodes (3): main(), require(), semver()

### Community 101 - "validate_handoff_observability_v518.py"
Cohesion: 0.83
Nodes (3): main(), require(), semver()

### Community 102 - "validate_legal_intelligence_prototype_v70.py"
Cohesion: 1.00
Nodes (3): fail(), main(), validate_deep_offers()

## Knowledge Gaps
- **65 isolated node(s):** `users`, `titles`, `statusLabels`, `loginView`, `portalView` (+60 more)
...
- **Why does `main()` connect `apply_handoff_observability_v518.py` to `apply_decision_compression_v531.py`, `apply_experience_v60.py`, `apply_capability_truth_v521.py`, `canonical_pipeline_v524.py`, `normalize_experience_compat_v60.py`, `apply_experience_sectors_v60.py`, `apply_experience_solutions_v60.py`, `main`, `apply_contact_compression_v523.py`?**
