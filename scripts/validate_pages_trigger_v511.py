...
def main() -> int:
    ...
    if "scripts/apply_fit_scope_clarity_v64.py" not in build_triggers:
        errors.append("build-canonical.yml: cambios del materializador Fit & Scope Clarity v6.4 deben disparar el builder")
    if "scripts/apply_delivery_plan_clarity_v65.py" not in build_triggers:
        errors.append("build-canonical.yml: cambios del materializador Delivery Plan Clarity v6.5 deben disparar el builder")
    ...
    print(
        ...
        "y el builder vigila validators + materializadores Search Discovery v6.2 / Engagement Clarity v6.3 / "
        "Fit & Scope Clarity v6.4 / Delivery Plan Clarity v6.5 antes de publicar."
    )
    return 0
